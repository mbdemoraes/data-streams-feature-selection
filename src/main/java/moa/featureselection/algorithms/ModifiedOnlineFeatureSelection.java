 ...
 * @see NumericToBinary
 */
public class ModifiedOnlineFeatureSelection extends ASEvaluation implements
  ...
  static double lambda = 0.01; // 0.01 According to authors' criterion  
   ...
   * Constructor
   */
  public ModifiedOnlineFeatureSelection(int numFeatures, double threshold) {
	this.numFeatures = numFeatures;
	this.lambda = threshold;
    resetOptions();
